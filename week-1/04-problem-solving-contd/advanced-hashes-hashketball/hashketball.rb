...
def num_points_scored(name)
  ...
  # given a name, find the player information

  # given with player, find the number of points scored
  
  player = player(name)
  player[:points]
end

# shoe_size("Jeff Adrien")).to eq(18)

def shoe_size(name)
  # give me a list of players
  # given a name, find the player information
  # give me the shoe size
  player = player(name)
  player[:shoe]
end
...
def big_shoe_rebounds
  ...
  player[:rebounds]
  # returns the number of rebounds of 
end
